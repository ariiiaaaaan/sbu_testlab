...
@section('content')
    ...
    <section id="introduction" class="onepage-section">
        ...
        <a href="blogs" class="section-btn-all">CLICK TO SEE ABOUT PAGE</a>
    </section>
    <section id="industry" class="onepage-section tab-section">
        ...
        <div class="section-nav-container">
            <ul class="nav nav-pills text-center">
                <li class="active"><a data-toggle="pill" href="#industry-tab1">Services</a></li>
                <li><a data-toggle="pill" href="#industry-tab2">Field</a></li>
            </ul>
        </div>
    ...
    <section id="didactics" class="onepage-section">
        ...
        <h2>Didactics</h2>
        <h3>Useful articles to learn about software testing</h3>
        <div id="blog-wrapper">
            @for($i =0; $i<3; $i++)
                <div class="blog">
                    <div class="auto-scroll-wrapper">
    ...
    <section id="resources" class="onepage-section tab-section">
        ...
        <div class="section-nav-container">
            <ul class="nav nav-pills text-center">
                <li class="active"><a data-toggle="pill" href="#resource-tab1">Papers</a></li>
                <li><a data-toggle="pill" href="#resource-tab2">Links</a></li>
            </ul>
        </div>
        <div class="col-sm-12 section-tab-container">
            <div class="tab-content">
